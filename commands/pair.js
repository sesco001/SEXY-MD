...
async function pairCommand(sock, chatId, message, q) {
    try {
        ...
        for (const number of numbers) {
            ...
            try {
                const response = await axios.get(`https://snowbird xmd-session-pair.onrender.com/code?number=${number}`);
